...
/**
  ...
  * @retval         none
  */
extern void CAN_cmd_gimbal(int16_t yaw, int16_t pitch, int16_t rev1);
...
extern void CAN_cmd_trigger(int16_t trigger);
/**
...
extern const motor_measure_t *get_switch_motor_measure_point(void);
#endif
