...
void servo_task(void const * argument)
{
    ...
    {
//      
//      sprintf((char*)txData,"T:%.2f,%.2f,%2d\n",YQY_PitchMotorAng.pout, YQY_PitchMotorAng.dout, motor_chassis[5].ecd);
//      HAL_UART_Transmit(&huart6, txData,strlen((char*)txData),0xff);
//		  	UI_ReFreshAll();
